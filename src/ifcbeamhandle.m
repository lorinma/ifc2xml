...
%    1 2013/09/15 完善此文件
% *************************************************************************************
function [docNode,globalFaceNo,globalLineNo,globalPointNo,txtfid]=ifcbeamhandle(filename,paramcontainer,lineid,docNode ,ifcbeamnumber,entityid,globalFaceNo,globalLineNo,globalPointNo,txtfid)
...
%    end
   ...
   ifcbeamentitynode.setAttribute('type','ifcbeam') ;
...
%              faceindex = ['face' num2str(udmfaceindex)] ; 
             ...
             ifcbeamPoint4 = ifcbeamFace(4,:);
                                 ...
                                 txttempcontent=[objectEntityID ' BEAM'];
